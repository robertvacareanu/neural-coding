 ...
 */
class TimeToFirstSpike(private val waveformInternalSampling: Float, private val eventStartTimes: List<Int>, private val emptyValue: Float = 0f) : ValueExtractor<Spike, Float> {
