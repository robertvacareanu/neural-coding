 ...
 */
class Width(private val waveformInternalSamplingFrequency: Float, private val spikeOffset: Int, private val emmptyValue: Float = 0f) : ValueExtractor<Spike, Float> {
    ...
    override fun extractValue(spike: Spike): Float {
        ...
        return if (p1 != null && p2 != null) {
            Point2D.distance(p1.x, p1.y, p2.x, p2.y).toFloat()
        } else {
            emmptyValue
        }
