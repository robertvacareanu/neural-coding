...
class FeatureExtractorTest {
    ...
    fun meanPerimeter() {
        ...
        val feature: List<Pair<Int, FloatArray>> = MeanPerimeter(1f).extract(listOf(TrialData(1, listOf(t1Channel1Data))))
        ...
        assert(result / 5 almostEqual MeanPerimeter(10f).extract(listOf(TrialData(1, listOf(t1Channel2Data))))[0].second[0])
    ...
    fun meanArea() {
        ...
        val feature = MeanArea(1.0f).extract(listOf(TrialData(1, listOf(t1Channel1Data))))
