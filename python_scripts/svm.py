...
def plot_svm(path, orientation1=0, orientation2=45, save_path=None):
...
parser.add_argument("-o", "--orientation", nargs="*", required=False, default=[0, 45],
                    help="Orientation to plot svm for. Default is 0 and 45")
parser.add_argument("-s", "--save", required=False, default=None, help="Path to save the plot. By default only displays the plot")

result = parser.parse_args(sys.argv[1:])
plot_svm(result.path, result.orientation[0], result.orientation[1], result.save)
